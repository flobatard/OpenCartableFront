 ...
 * encadrés, colonnes — déclarés ici, leurs slugs sont réservés) puis les extensions du registry, dont le
...
export const BUILTIN_DOC_PAGES: readonly DocPage[] = [
  ...
  {
    slug: 'columns',
    loadComponent: () => import('./columns-doc/columns-doc').then((m) => m.ColumnsDoc),
  },
];
