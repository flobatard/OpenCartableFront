...
describe('registerCourseMonacoLanguages', () => {
  ...
  it('registers latex, mermaid and oc-markdown with a tokenizer', () => {
  ...
  it('applies the language configuration to oc-markdown', () => {
    const { monaco, languages } = fakeMonaco();
    registerCourseMonacoLanguages(monaco);
  ...
  it('defines the oc-vs and oc-vs-dark accent themes', () => {
...
describe('ocMarkdownLanguage', () => {
  it("keeps the math block pop rule (invariant monaco enforces at runtime)", () => {
  ...
  it('places inline math rules after inline code in linecontent', () => {
