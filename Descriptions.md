...
| **J5 — IA** *(2 briques livrées)* | **Assistant de cours** : chat par cours à conversations persistées, agent + tools (lecture de blocs, extraction PDF), citations de sources, **chat d'édition de bloc texte à flux HITL** (proposition en diff, Appliquer/Rejeter dans l'éditeur) — cf. §5.7 ; restent les contextes exercice/module et la résolution d'exercice, le chat élève, la vectorisation (ChromaDB, si actée) et le RAG | Interroger, critiquer et synthétiser un cours avec l'IA |
