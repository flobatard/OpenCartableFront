...
| **J5 — IA** *(3 briques livrées)* | **Assistant de cours** : chat par cours à conversations persistées, agent + tools (lecture de blocs, extraction PDF), citations de sources, **chats d'édition à flux HITL** — bloc texte (proposition en diff) et exercice (propositions par question, revue structurée), Appliquer/Rejeter dans l'éditeur — cf. §5.7 ; restent le contexte module et la résolution d'exercice, le chat élève, la vectorisation (ChromaDB, si actée) et le RAG | Interroger, critiquer et synthétiser un cours avec l'IA |
